...
public class DirectChannelApplication implements CommandLineRunner, ExitCodeGenerator {
	private static final Logger logger = LogManager.getLogger(DirectChannelApplication.class);
